...
def main():
    ...
    report = {
        ...
        "recommended_reply": "The paper file did not land in the current FastClaw workspace. Re-upload it through the file picker or Open files for this chat, then run the popular-article workflow again.",
        "next_actions": [
